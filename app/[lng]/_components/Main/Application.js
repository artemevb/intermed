        ...
        <div className="bg-contactBg p-4 pb-9 mdx:px-[40px] lg:py-[40px] xl:px-[80px] 2xl:px-[120px] xl:py-[80px]">
            {
                isMounted && <div className="">
                    <div className="lg:flex lg:flex-row lg:justify-between max-w-[1440px] mx-auto">
                        <h3 className="text-[25px]  text-[#fff] mdx:font-semibold mdx:text-[32px] mdl:text-[40px] uppercase  pt-[20px] pb-[17px] mdx:pt-[30px] mdx:pb-[30px] 3xl:text-[45px] xl:pt-0 lg:leading-[55px]">{t('questions')}<br />
                            {t('contact')}</h3>
