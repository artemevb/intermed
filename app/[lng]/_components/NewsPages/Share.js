...
export default function NewsTitle() {
	...
	const [news, setNews] = useState(null) // Initial state is set to null
	...
	const icons = [
        ...
        { src: facebook, alt: 'Facebook Icon', link: 'https://www.facebook.com/intermed.mindray' },
        { src: instagr, alt: 'Instagram Icon', link: 'https://www.instagram.com/intermed.mindray' },
