...
export default function VideoReview({ videos }) {
    ...
    // Show only the first 3 videos unless 'showAll' is true
    ...
    return (
        <section className="w-full max-w-[1440px] 5xl:max-w-[2000px] mx-auto flex flex-col gap-8 px-2">
                ...
                {visibleVideos.map((video, index) => (
                    video.url && (
                        <div key={index} className="w-full">
                            ...
                            <div className="mt-2 text-black font-medium text-[18px] mdx:text-[24px]">
            ...
            {/* Conditionally render the button only if there are more than 3 videos */}
            {videos.length > 3 && (
